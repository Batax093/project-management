        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative ">
            <input
              ...
              className="rounded-md border pl-10 py-1 pr-4 focus:outline-none dark:border-dark-secondary dark:text-white"
            />
...
const TabButton = ({ name, icon, setActiveTab, activeTab }: TabButtonsProps) => {
