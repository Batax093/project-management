...
const columns: GridColDef[] = [
  ...
  },
  {
    ...
    width: 130,
    renderCell: (params) => (
      <span className="inline-flex rouded-full bg-green-100 px-2 text-xs font-semibold leading-5 text-green-800">{params.value}</span>
    ),
  },
  {
    field: "priority",
...
const ReuseablePriority = ({ priority }: Props) => {
...
export default ReuseablePriority;
